<link rel="stylesheet" href="<?php echo fileUri(); ?>/assets/css/single.css?v=<?=THEME_VERSION?>">
<link rel="stylesheet" href="<?php echo fileUri(); ?>/assets/static/fancybox/fancybox.css?v=<?=THEME_VERSION?>">
