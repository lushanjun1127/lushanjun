...
?>
  ...
  <link rel="stylesheet" href="<?php echo fileUri(); ?>/assets/static/swiper/swiper-bundle.min.css?v=<?=THEME_VERSION?>">
  <?php
  ...
  <div class="top">
    ...
    <script src="<?php echo fileUri(); ?>/assets/static/swiper/swiper-bundle.min.js?v=<?=THEME_VERSION?>"></script>  
    <script>
