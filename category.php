                    ...
                    <a href="<?php the_permalink(); ?>">
                      <?php
                        if (has_post_thumbnail()) {
                          ...
                          <img src="<?php if(first_post_cover(get_the_content())){echo first_post_cover(get_the_content());}else{echo default_post_cover();} ?>?<?=the_title()?>=<?php $cate_i++; echo $cate_i; ?>" alt="" loading="lazy">
                        <?php }
                      ?>
                    </a>
                  </div>
